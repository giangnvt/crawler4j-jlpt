 ...
 */
public class JlptGrammarTestCrawler extends WebCrawler {

    private static final Pattern IMAGE_EXTENSIONS = Pattern.compile(".*\\.(bmp|gif|jpg|png)$");
    private static final String ITEM_URL_PATTERN = "http://japanesetest4you\\.com/japanese-language-proficiency-test-jlpt-n\\d+-grammar-exercise(.*)";
...
//            }
            ...
            if (matched) {
                try {
                    ...
                    if (urlTokens.length == 0) return;
                    String originalFileName = urlTokens[urlTokens.length - 1];
